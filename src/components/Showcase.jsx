...
/**
 * §7 — data shape. A showcase is `{ brand, title, subtitle, year, items }`,
 * where `brand` is the eyebrow ("HIRANANDANI DASHBOARD"), `title` the hero
 * title ("Fortune City"), `subtitle` the line under it ("HIRANANDANI FORTUNE
 * CITY"), `year` the edition, and each item is `{ id, name, image, href }`.
 */
 ...
 */
export function Showcase({ showcase, onBack }) {
