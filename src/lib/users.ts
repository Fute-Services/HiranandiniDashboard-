 ...
 *   session reports (via `managerEmail` below), doesn't run client
 *   presentations themselves.
 * - sales_staff — runs the actual client presentations (lead lookup → Earth
 *   → VR/cards showcase); no reporting access. Each is assigned to exactly
 *   one manager via `managerEmail` — that's the "team" a manager's
