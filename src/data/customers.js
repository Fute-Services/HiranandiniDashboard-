 ...
 * plugs in.
 *
 * `lib/leads.js` asks `/api/leads` (Postgres) first and falls back to this
 ...
 *
 * Keep these in the same shape as a lead (see lib/leads.js) so the swap is a
 * one-file change.
 */
...
export function findDummyCustomer(query) {
